                    ...
                    <div className='flex flex-wrap -m-4 text-center'>
                        ...
                        <div className='p-4 md:w-1/3 sm:w-1/2 w-full'>
                            ...
                            >
                                ...
                                <p className='leading-relaxed'>
                                    Вся наша продукция изготовлена из высококачественных материалов.
                                    Мы тщательно отбираем ткани и следим за каждой деталью, чтобы
                                    обеспечить вам максимальный комфорт и стиль.
                                </p>
                            </div>
                        </div>
