		...
		<Layout>
			...
			>
				...
				<div className='mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 '>
					<div className='rounded-lg md:w-2/3 '>
						{cartItems.map((item, index) => {
							...
							return (
								<div
									key={index}
									className='justify-between mb-6 rounded-lg   drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start'
									style={{
					...
					<div
						className='mt-6 h-full rounded-lg  bg-white p-6 shadow-md md:mt-0 md:w-1/3'
						style={{
							backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '',
							color: mode === 'dark' ? 'white' : '',
						}}
