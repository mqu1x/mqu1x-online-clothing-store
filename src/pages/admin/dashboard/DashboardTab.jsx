					...
					<Tabs defaultIndex={0} className=' '>
						<TabList className='md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 '>
							<Tab>
								<button
									type='button'
									className='font-medium border-2  rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]  px-5 py-1.5 text-center bg-[#605d5d12] '
									style={{ borderColor: '#d60f9a', color: 'white' }}
								>
							...
							<Tab>
								<button
									type='button'
									className='font-medium border-2 rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)] px-5 py-1.5 text-center '
									style={{ borderColor: '#d60f9a', color: 'white' }}
								>
									<div className='flex gap-2 items-center'>
										<AiFillShopping /> Заказы
									</div>
								</button>
							</Tab>
							<Tab>
								<button
									type='button'
									className='font-medium border-2  rounded-lg text-xl    px-5 py-1.5 text-center '
									style={{ borderColor: '#d60f9a', color: 'white' }}
								>
									<div className='flex gap-2 items-center'>
										<FaUser /> Пользователи
